...
{
    public sealed class ActionMenuView : IActionMenuView
    {
        ...
        private ToolStripMenuItem ToolStripMenuItemHandler(string displayText, string toolTipText, EventHandler eventHandler)
        {
